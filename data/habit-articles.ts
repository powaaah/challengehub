...
export const habitArticles: HabitArticle[] = [
  {
    title: "Die 7 Habit Rules für Challenges",
    ...
    seoDescription: "Die wichtigsten Habit Rules für Challenges: Auslöser, kleine Schritte, Belohnung, Umgebung, Identität und Wenn-Dann-Pläne.",
    sources: [
    ...
    takeaways: [
      "Eine Challenge braucht einen sichtbaren Auslöser.",
      "Die erste Version muss so leicht sein, dass du sie auch an schlechten Tagen schaffst.",
      "Belohnung und Fortschritt müssen sofort spürbar sein.",
      "Deine Umgebung gewinnt oft gegen reine Willenskraft.",
      "Eine gute Challenge beantwortet: Wer werde ich dadurch?"
    ],
    sections: [
      {
        heading: "1. Mach den Auslöser sichtbar",
        body: [
          "Viele Gewohnheiten scheitern nicht an Faulheit, sondern daran, dass sie im Alltag nicht auftauchen. Wenn du eine Challenge starten willst, braucht sie einen klaren Trigger: nach dem Zähneputzen, nach dem Kaffee, direkt nach Feierabend oder vor dem ersten Scrollen am Handy.",
          "Charles Duhigg beschreibt Gewohnheiten als Schleife aus Auslöser, Routine und Belohnung. Für ChallengeHub heißt das: Jede Challenge sollte nicht nur ein Ziel haben, sondern einen konkreten Moment, an dem sie beginnt."
        ],
        bullets: ["Schuhe sichtbar an die Tür stellen.", "Lernbuch auf den Schreibtisch legen.", "Workout-Kleidung am Vorabend bereitlegen."]
      },
      {
        heading: "2. Starte kleiner als dein Ego will",
        body: [
          "BJ Fogg macht in Tiny Habits stark, dass Verhalten leichter startet, wenn es klein genug ist. Nicht: Ich trainiere jeden Tag eine Stunde. Sondern: Ich mache nach dem Kaffee zwei Liegestütze. Die kleine Version wirkt unspektakulär, aber sie entfernt Reibung.",
      ...
      },
      {
        ...
        body: [
          "Menschen wiederholen Verhalten eher, wenn es sich direkt sinnvoll oder belohnend anfühlt. Darum funktionieren Streaks, Fortschrittsbalken und abgehakte Tagesfelder so gut.",
          "Bei ChallengeHub sollte jede Challenge langfristig trackbar sein: erledigt, nicht erledigt, Serie, persönlicher Rekord, nächster Meilenstein."
        ]
      },
      {
        heading: "4. Baue Umgebung statt Willenskraft",
        body: [
          "Wendy Wood betont, wie stark Gewohnheiten an Kontext und Umgebung hängen. Wenn die Umgebung gegen dich arbeitet, brauchst du jeden Tag neue Disziplin. Wenn sie für dich arbeitet, wird das richtige Verhalten wahrscheinlicher.",
      ...
      {
        heading: "5. Nutze Wenn-Dann-Pläne",
        body: [
          "Wenn-Dann-Pläne machen aus einem Vorsatz eine konkrete Reaktion. Beispiel: Wenn ich nach der Arbeit nach Hause komme, ziehe ich sofort Laufschuhe an. Das nimmt dir die Verhandlung mit dir selbst ab.",
          "Für Challenges ist das Gold: Je klarer die Situation und die Reaktion, desto weniger brauchst du Motivation."
        ],
        bullets: ["Wenn ich mein Handy entsperre, trinke ich zuerst Wasser.", "Wenn ich den Laptop zuklappe, gehe ich 10 Minuten raus.", "Wenn ich Heißhunger bekomme, esse ich zuerst Protein oder Obst."]
      },
      {
        heading: "6. Koppel die Challenge an Identität",
        body: [
          "Atomic-Habits-Logik ist nicht nur: Was will ich erreichen? Sondern: Welche Art Mensch werde ich? Eine Lauf-Challenge ist stärker, wenn sie nicht nur 5 km unter 20 Minuten verspricht, sondern dich als Läufer denken lässt.",
          "Darum sollten Challenge-Seiten nicht nur Ziele zeigen, sondern auch eine Identitätsformel: Diese Challenge ist für Menschen, die..."
        ]
      },
      {
        heading: "7. Plane den Neustart vor dem Rückfall",
        body: [
          "Rückfälle sind normal. Gefährlich ist nicht ein verpasster Tag, sondern der zweite und dritte. Eine gute Habit Rule lautet: Nie zweimal hintereinander ausfallen lassen.",
  ...
  {
    title: "Tiny Habits: Warum kleine Versionen große Challenges retten",
    slug: "tiny-habits-challenges",
    category: "Methode",
    readTime: "5 min",
    publishedAt: "2026-06-03",
    excerpt: "Die kleinste Version einer Challenge ist oft nicht peinlich, sondern strategisch klug.",
    seoDescription: "Tiny Habits für Challenges: Wie kleine Gewohnheiten, Prompts und direkte Belohnung große Ziele leichter starten lassen.",
    sources: [
    ...
    sections: [
      {
        heading: "Das Problem mit großen Starts",
        body: [
      ...
      },
      {
        ...
        bullets: ["Original: Jeden Tag 60 Minuten lernen. Tiny: Eine Karteikarte nach dem Kaffee.", "Original: 100 Burpees pro Tag. Tiny: 5 Burpees nach dem Zähneputzen.", "Original: 10.000 Schritte. Tiny: 5 Minuten direkt nach dem Mittagessen gehen."]
      }
    ]
  },
  {
    title: "Cue, Routine, Reward: Die Habit Loop für ChallengeHub",
    slug: "cue-routine-reward-challengehub",
    category: "Framework",
    readTime: "6 min",
    publishedAt: "2026-06-03",
    excerpt: "Wie Auslöser, Routine und Belohnung aus einem Ziel eine wiederholbare Challenge machen.",
    seoDescription: "Cue, Routine, Reward für Challenges: So wird aus einem Ziel eine Gewohnheit mit Trigger, Aktion und Belohnung.",
    sources: [
      { label: "The Power of Habit von Charles Duhigg", url: "https://charlesduhigg.com/the-power-of-habit/" },
      { label: "Good Habits, Bad Habits von Wendy Wood", url: "https://us.macmillan.com/books/9781250159083/goodhabitsbadhabits/" },
    ...
    sections: [
      ...
      {
        heading: "So könnte ChallengeHub daraus Produktlogik machen",
        body: [
        ...
        bullets: ["Cue: Wann mache ich es?", "Routine: Was genau mache ich?", "Reward: Was sehe/spüre ich direkt danach?", "Fallback: Was ist die kleinste Version an schlechten Tagen?"]
      }
    ]
  }
];
